...
- Fixed the legacy Bash installer to download from the repository's `main` branch and fail cleanly on HTTP errors; its smaller command set is now documented separately from the full Node CLI.
